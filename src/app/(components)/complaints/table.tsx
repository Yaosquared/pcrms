...
const ComplaintsTable = async ({
  ...
  const complaintsData = await fetchRecords(search, page);
  ...
  return (
    <>
      <div>
            ...
            <tbody>
              {complaintsData.map((complaint) => (
                ...
                >
                  ...
                  <td className="px-1">
                    {getCreatedDate(complaint.createdAt)}
                  </td>
                  <td className="px-1">
                    {getUpdatedDate(complaint.updatedAt)}
                  </td>
                  <td>
        ...
        <Pagination complaintsDataLength={complaintsDataLength} />
      </div>
    </>
  );
};
