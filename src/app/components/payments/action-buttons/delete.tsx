...
import PaymentDeleteForm from "../delete-form";
  ...
  return (
    <>
      <MdDelete
        ...
        size={20}
        onClick={handleOpen}
        className="text-red-600 hover:text-red-700 hover:scale-105 lg:w-6 lg:h-6 2xl:w-7 2xl:h-7 transition duration-300 ease-in-out"
      />
      <Modal
        open={isModalOpen}
        onClose={handleClose}
