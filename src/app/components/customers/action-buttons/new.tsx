...
const NewButton = () => {
  ...
  return (
    <>
      <button
        onClick={handleOpen}
        className="flex flex-row items-center rounded-md p-2 lg:space-x-1 lg:px-4 lg:py-3 bg-blue-600 hover:bg-blue-700 text-white shadow-md transition duration-300 ease-in-out"
      >
        <FiPlus size={20} />
